...
class WorkflowConfig:
    ...
    enable_experiment_budgeting: bool = True
    ...
    experiment_budget_mode: str = "advisory"
    experiment_budget_total_hint: int = 200
    experiment_budget_refresh_interval_iterations: int = 50
    experiment_budget_refresh_interval_hours: int = 24
    experiment_budget_legacy_min_ratio: float = 0.15
    experiment_budget_random_min_ratio: float = 0.05
    experiment_budget_treatment_max_ratio: float = 0.40
    experiment_budget_min_samples_for_adjustment: int = 30
    experiment_budget_high_failure_rate_threshold: float = 0.70
    experiment_budget_high_sc_abs_max_threshold: float = 0.70
    experiment_budget_high_quality_pass_threshold: float = 0.30
    experiment_budget_allow_governance_veto: bool = True
    experiment_budget_fail_open_tracking_only: bool = True
    enable_decision_snapshots: bool = True
    decision_snapshot_status_path: str = "runtime/status/decision_snapshot_status.json"
    decision_snapshot_record_parent_selection: bool = True
    decision_snapshot_record_mutation_policy: bool = True
    decision_snapshot_record_sc_fallback: bool = True
    decision_snapshot_record_simulator_skip: bool = True
    decision_snapshot_record_experiment_arm_selection: bool = True
    decision_snapshot_record_budget_plan_selection: bool = True
    decision_snapshot_record_candidate_acceptance: bool = True
    decision_snapshot_fail_open: bool = True
    enable_offline_replay: bool = False
    enable_counterfactual_evaluation: bool = False
    enable_support_checker: bool = True
    enable_strategy_registry: bool = True
    strategy_scoreboard_status_path: str = "runtime/status/strategy_scoreboard.json"
    strategy_registry_mode: str = "advisory"
    strategy_scoreboard_auto_refresh: bool = False
    strategy_scoreboard_default_limit: int = 1000
    strategy_score_min_samples: int = 30
    strategy_score_medium_samples: int = 100
    strategy_score_high_samples: int = 500
    strategy_high_sc_abs_max_threshold: float = 0.70
    strategy_fail_open: bool = True
    enable_strategy_champion_challenger: bool = False
    strategy_portfolio_status_path: str = "runtime/status/strategy_portfolio_report.json"
    strategy_portfolio_mode: str = "advisory"
    strategy_portfolio_auto_refresh: bool = False
    strategy_portfolio_fail_open: bool = True
    strategy_default_champion: str = "legacy_baseline"
    strategy_challenger_min_samples: int = 100
    strategy_limited_active_min_samples: int = 500
    strategy_challenger_min_confidence: str = "medium"
    strategy_limited_active_min_confidence: str = "high"
    strategy_block_high_sc_risk: bool = True
    strategy_allow_auto_champion_promotion: bool = False
    strategy_transition_auto_apply: bool = False
    enable_strategy_budget_allocator: bool = False
    strategy_budget_status_path: str = "runtime/status/strategy_budget_report.json"
    strategy_budget_mode: str = "advisory"
    strategy_budget_auto_refresh: bool = False
    strategy_budget_total_hint: int = 200
    strategy_budget_fail_open: bool = True
    strategy_budget_legacy_min_ratio: float = 0.40
    strategy_budget_exploration_min_ratio: float = 0.05
    strategy_budget_shadow_max_ratio: float = 0.02
    strategy_budget_challenger_max_ratio: float = 0.20
    strategy_budget_limited_active_max_ratio: float = 0.35
    strategy_budget_high_risk_max_ratio: float = 0.05
    strategy_budget_high_sc_max_ratio: float = 0.05
    strategy_budget_insufficient_evidence_max_ratio: float = 0.02
    strategy_budget_non_champion_max_ratio: float = 0.35
    strategy_budget_normalization_tolerance: float = 0.001
    strategy_budget_auto_apply: bool = False
    strategy_budget_allocator_auto_apply: bool = False
    enable_observability_metrics: bool = True
    observability_metrics_status_path: str = "runtime/status/observability_metrics.json"
    observability_mode: str = "metrics_only"
    observability_auto_collect: bool = False
    observability_fail_open: bool = True
    observability_status_max_age_seconds: int = 86400
    observability_recent_window: int = 100
    observability_metrics_default_limit: int = 1000
    observability_collect_workflow: bool = True
    observability_collect_ml: bool = True
    observability_collect_governance: bool = True
    observability_collect_experiment: bool = True
    observability_collect_offline: bool = True
    observability_collect_strategy: bool = True
    observability_collect_system: bool = True
    enable_observability_alerts: bool = False
    enable_observability_drift_detection: bool = False
    enable_observability_diagnosis: bool = False
    observability_alerts_status_path: str = "runtime/status/observability_alerts.json"
    observability_diagnosis_status_path: str = "runtime/status/health_diagnosis.json"
    observability_alert_mode: str = "advisory"
    observability_alert_auto_emit: bool = False
    observability_diagnostics_auto_run: bool = False
    observability_auto_remediation: bool = False
    observability_drift_window_size: int = 20
    observability_drift_baseline_window_size: int = 100
    observability_failure_spike_threshold: float = 0.5
    observability_success_drop_threshold: float = 0.3
    observability_sc_risk_threshold: float = 0.7
    observability_warning_count_threshold: int = 5
    observability_disk_low_mb_threshold: int = 1024
    observability_source_stale_seconds: int = 86400
    observability_diagnosis_fail_open: bool = True
    enable_run_explainability: bool = False
    run_explain_report_status_path: str = "runtime/status/run_explain_report.json"
    daily_observability_report_status_path: str = "runtime/status/daily_observability_report.json"
    stage7_summary_report_status_path: str = "runtime/status/stage7_summary_report.json"
    observability_explainability_mode: str = "explain_only"
    observability_explainability_auto_run: bool = False
    observability_explainability_fail_open: bool = True
    observability_explanation_recent_limit: int = 1000
    observability_explanation_include_counterfactual: bool = True
    observability_explanation_include_budget: bool = True
    observability_explanation_include_alerts: bool = True
    observability_explanation_include_diagnosis: bool = True
    observability_explanation_auto_action: bool = False
    enable_legacy_iteration_observer: bool = True
    legacy_runtime_state_path: str = "runtime/status/runtime_state.json"
    legacy_recent_events_path: str = "runtime/status/recent_events.jsonl"
    legacy_learning_evidence_path: str = "runtime/status/legacy_learning_evidence.jsonl"
    legacy_observer_fail_open: bool = True
    legacy_observer_max_event_payload_chars: int = 1000
    legacy_observer_max_message_chars: int = 300
    legacy_recent_events_max_bytes: int = 5_242_880
    legacy_learning_evidence_max_bytes: int = 10_485_760
    legacy_observer_write_runtime_state: bool = True
    legacy_observer_write_recent_events: bool = True
    legacy_observer_write_learning_evidence: bool = True
    legacy_observer_include_alpha_expression: bool = False
    legacy_observer_include_template_body: bool = False
    legacy_observer_include_traceback: bool = False
